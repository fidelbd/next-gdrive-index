...
const config: z.input<typeof Schema_Config> = {
  ...
  apiConfig: {
     ...
     */
    rootFolder:
      "8cb837ed6d4994e0215762099d2aa70ff6d4319a3a87451090b79ab25c15c0383708315ecf349eb3c3a09cef8238f04b36;3c3679eff962f8ec23178155",
  ...
  siteConfig: {
    ...
    siteDescription: "Neo-Raws Upscale Projects",
    siteIcon: "/logo.svg",
    siteAuthor: "neo_raws",
    favIcon: "/favicon.png",
    /**
    ...
    navbarItems: [
  {
    "icon": "Link",
    "name": "Discord",
    "href": "https://discord.gg/AyrjGr3D6S",
    "external": true
  }
],
